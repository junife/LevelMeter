...
#define BUFFER_SIZE	2				/// define buffer size is 1 bytes or 2 bytes
//#define COMPILER_TYPE_WIN_GCC_		/// define it for debug in PC with GUN GCC
...
//! cBuffer structure
typedef struct struct_cBuffer_ex
{
	BUFFER_TYPE *dataptr;			///< the physical memory address where the buffer is stored
